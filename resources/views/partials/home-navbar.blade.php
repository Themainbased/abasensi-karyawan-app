<nav class="navbar navbar-expand-md bg-dark navbar-dark py-3">
    <div class="container">
        ...
        <a class="navbar-brand bg-transparent fw-bold" href="{{ route('home.index') }}">Selamat Datang Di Absesni App</a>
            ...
            <ul class="navbar-nav align-items-md-center gap-md-4 py-2 py-md-0">
                ...
                <li class="nav-item px-4 py-1 px-md-0 py-md-0">
                    <form action="{{ route('auth.logout') }}" method="post">
                        ...
                        <button class="btn fw-bold btn-outline-danger w-100">Keluar</button>
                    </form>
                </li>
            </ul>
        </div>
